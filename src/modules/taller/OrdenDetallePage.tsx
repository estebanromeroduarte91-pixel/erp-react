...
import { useOrdenes, useGuardarOrden, useMsgTemplates, useSeguimientoConfig } from '@/lib/queries'
...
import type { EstadoOrden, Inspeccion } from '@/types'
        ...
        <div className="w-80 flex-shrink-0 border-r border-gray-100 overflow-y-auto p-5 space-y-5">
          ...
          <div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                {o.tel && (
                  <a href={`tel:${o.tel}`} className="text-xs text-blue-600 hover:underline block mt-1">{o.tel}</a>
                )}
              ...
              {o.tel && (
                <a href={`https://wa.me/${o.tel.replace(/\D/g, '')}`} target="_blank" rel="noreferrer"
                  className="w-8 h-8 rounded-lg bg-green-50 flex items-center justify-center hover:bg-green-100 transition flex-shrink-0" title="WhatsApp">
          ...
          {o.estadoFisico && (
            <div>
              ...
              <p className="text-sm text-gray-700 bg-gray-50 rounded-xl p-3 leading-relaxed">{o.estadoFisico}</p>
            </div>
          )}
