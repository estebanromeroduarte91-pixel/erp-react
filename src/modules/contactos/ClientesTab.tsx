      ...
      <div style={{ width: isMobile ? '100%' : 300, flexShrink: 0, borderRight: '0.5px solid #e5e7eb', display: 'flex', flexDirection: 'column', background: '#fafafa' }}>
        <div style={{ padding: '12px 12px 8px', borderBottom: '0.5px solid #e5e7eb' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
            ...
            <button 
              id="tour-contactos-btn-nuevo-cliente"
              onClick={abrirNuevo} 
              style={{ background: 'var(--primary)', color: '#fff', border: 'none', borderRadius: 8, width: 32, height: 32, display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', flexShrink: 0 }}
            >
