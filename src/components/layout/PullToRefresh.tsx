  ...
  return (
    <div onTouchStart={onTouchStart} onTouchMove={onTouchMove} onTouchEnd={onTouchEnd}>
      <div style={{
        ...
        transition: active.current ? 'none' : 'transform .2s ease, opacity .2s ease',
        opacity: visible ? 1 : 0,
      }}>
        <div style={{
          ...
          {refreshing ? (
            ...
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#3656e6" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"
              style={{ transform: `rotate(${Math.min(pull / THRESHOLD, 1) * 270}deg)`, transition: active.current ? 'none' : 'transform .2s' }}>
